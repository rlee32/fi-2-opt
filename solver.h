...
inline Move first_improvement_sorted(const std::vector<Segment>& segments, const DistanceCalculator& dt)
{
...
inline Move first_improvement_random(const std::vector<Segment>& segments, const DistanceCalculator& dt)
{

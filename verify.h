...
inline std::vector<primitives::point_id_t> reproduce_next(const std::vector<Segment>& segments)
{
...
inline bool valid_cycle(const std::vector<Segment>& segments)
{
    for (const auto& s : segments)
    {
...
inline primitives::length_t tour_length(const std::vector<Segment>& segments)
{
